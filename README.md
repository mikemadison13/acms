...
```
$ composer create-project --no-interaction acquia/drupal-recommended-project acms
```
...
$ git status
$ git add -p
$ git commit -m"acms-000: Committing new changes to site."
$ git push --set-upstream origin acms-000-new-site-change
```
...
* Local site URL: http://acms.lndo.site
